...
@section('admin_content')
    ...
    <form action="{{ url('admin/page/privacy/update') }}" method="post">
        @csrf
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="seo_title" class="form-control" value="{{ $page_privacy->seo_title }}">
                </div>
                <div class="form-group">
                    <label for="">Meta Description</label>
                    <textarea name="seo_meta_description" class="form-control h_100" cols="30" rows="10">{{ $page_privacy->seo_meta_description }}</textarea>
                </div>

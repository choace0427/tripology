...
<div class="container">
    ...
    <div class="portfolio-page pt_40 bg-area">
            ...
            <div class="row">
                      <div class="col-md-12">
                        <div class="babba dation">
                         ...
                         <h3><i class="bi bi-star-fill"></i>Travel Terms & Conditions</h3>
                         ...
                         <div class="destination-border">
                         <h3 class="mt-3"><i class="bi bi-star-fill"></i>Important Notes</h3>
                         ...
                         <div class="destination-border">
                         <h3 class="mt-3"><i class="bi bi-star-fill"></i>Booking your Vacation with Air</h3>
                         ...
                         <div class="destination-border">
                         <h3 class="mt-3"><i class="bi bi-star-fill"></i>Air-Inclusive Vacations — Applicable Taxes & Fees</h3>
                         ...
                         <div class="destination-border">
                         <h3 class="mt-3"><i class="bi bi-star-fill"></i>“Starting from prices” Disclaimer</h3>
